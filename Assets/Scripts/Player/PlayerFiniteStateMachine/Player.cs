...
public class Player : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        /*mainWeapon = transform.Find("PrimaryWeapon").GetComponent<Weapon>();
        secondaryWeapon = transform.Find("SecondaryWeapon").GetComponent<Weapon>();
        
        mainWeapon.SetCore(Core);
        ...
        /*PrimaryAttackState = new PlayerAttackState(this, StateMachine, playerData, "attack", mainWeapon, CombatInputs.primary);
